return {
    ...
    toggle_divider_description = {
        en = "The skull thing between hints and the prompt.",
    },
    toggle_prompt = {
        en = "Hide Prompt",
    },
    ...
    toggle_skull_description = {
        en = "Spinning skull logo on the loading screen. I recommend you leave this on so you know the game hasn't crashed.",
    },
}
